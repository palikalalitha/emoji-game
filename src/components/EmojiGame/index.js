      ...
      <div className="app-container">
        ...
        <div className="instructions-container">
          ...
          <div className="instructions-body">
            <p>
              <b> 🎮 1. Start the Fun!</b>
              <br /> Click on any emoji to kick off the game, but here’s the
              catch—don’t click the same emoji twice! 🤔
            </p>
            <p>
              <b>🏆 2. Score Up! </b> <br /> Each new emoji you click will earn
              you 1 point. Can you beat your own record? Keep going!
            </p>
            <p>
              <b>🎯 3. Challenge Yourself!</b> <br /> The real challenge: Click
              all the emojis without repeating! The more you play, the better
              you get!
            </p>
          </div>
          <div className="instructions-footer">
            💯 Top Score Saved: Your highest score will be saved for future
            games. Keep improving and aim for the stars! 🌟
          </div>
        </div>
